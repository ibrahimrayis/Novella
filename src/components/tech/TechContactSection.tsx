...
const TechContactSection: React.FC = () => {
  ...
  return (
    <section id="contact" className="section-padding bg-gray-50">
      <div className="container mx-auto px-4 md:px-6">
        <SectionTitle 
          title="Get In Touch"
          subtitle="Ready to start your digital transformation? Contact our team to discuss your project needs."
        />
        ...
        <div className="grid grid-cols-1 md:grid-cols-2 gap-12">
          <div className="bg-white shadow-md rounded-lg p-8 animate-fade-in">
            <form onSubmit={handleSubmit}>
              ...
              <Button 
                type="submit" 
                className="bg-novella-red hover:bg-red-700 text-white w-full"
              ...
              <div className="space-y-4">
                <div className="flex items-start">
                  ...
                  <div>
                    ...
                    <p className="text-novella-red">tech@novellaltd.com</p>
                  </div>
                </div>
                <div className="flex items-start">
                  <div className="bg-red-100 rounded-full p-3 mr-4">
                  ...
                  <div>
                    ...
                    <p className="text-novella-red">+90 555 123 4567</p>
                  </div>
                </div>
                <div className="flex items-start">
                  <div className="bg-red-100 rounded-full p-3 mr-4">
