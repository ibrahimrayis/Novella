      ...
      <main className="flex-grow">
        ...
        <section className="py-20 bg-novella-navy relative">
          ...
          <div className="container mx-auto px-4 md:px-6 relative z-10">
            <SectionTitle 
              title={t('about.ourAchievements')}
              subtitle={t('about.ourAchievementsSubtitle')}
        ...
        {/* CTA Section */}
        <CTASection 
          title={t('about.readyToCollaborate')}
          subtitle={t('about.readyToCollaborateSubtitle')}
          buttonText={t('about.contactUsToday')}
          buttonLink="/contact"
